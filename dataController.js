...
const DataController = (() => {
    ...
    const STOCK_PROFILES = {
        AEFES: { name: 'Anadolu Efes', sector: 'Gıda, İçecek', basePrice: 20.46, volatility: 0.026, drift: 0.0005, avgVolume: 42120000 },
        AGESA: { name: 'Agesa Hayat ve Emeklilik', sector: 'Sigorta', basePrice: 240.2, volatility: 0.018, drift: 0.0008, avgVolume: 1159499 },
        AKBNK: { name: 'Akbank', sector: 'Bankacılık', basePrice: 68.75, volatility: 0.021, drift: 0.0008, avgVolume: 16362000 },
        ...
        AKSEN: { name: 'Aksa Enerji', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 92.1, volatility: 0.018, drift: 0.0007, avgVolume: 5820000 },
        ALARK: { name: 'Alarko Holding', sector: 'Holding ve Yatırım', basePrice: 100.3, volatility: 0.023, drift: 0.0006, avgVolume: 6378000 },
        ALBRK: { name: 'Albaraka Türk', sector: 'Bankacılık', basePrice: 8.13, volatility: 0.03, drift: 0.0007, avgVolume: 110160000 },
        ALFAS: { name: 'Alfa Solar Enerji', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 45.98, volatility: 0.029, drift: 0.0008, avgVolume: 24282000 },
        ARCLK: { name: 'Arçelik', sector: 'Dayanıklı Tüketim', basePrice: 98.9, volatility: 0.017, drift: 0.0008, avgVolume: 4470000 },
        ASELS: { name: 'Aselsan', sector: 'Savunma Sanayii', basePrice: 370.0, volatility: 0.017, drift: 0.0007, avgVolume: 1899000 },
        ASTOR: { name: 'Astor Enerji', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 325.75, volatility: 0.016, drift: 0.0006, avgVolume: 2059500 },
        BERA: { name: 'Bera Holding', sector: 'Holding ve Yatırım', basePrice: 15.0, volatility: 0.022, drift: 0.0003, avgVolume: 59490000 },
        BIMAS: { name: 'BİM Mağazalar', sector: 'Perakende Ticaret', basePrice: 372.5, volatility: 0.017, drift: 0.0007, avgVolume: 936000 },
        BRSAN: { name: 'Borusan Mannesmann', sector: 'Metal Ana Sanayii', basePrice: 536.0, volatility: 0.015, drift: 0.0005, avgVolume: 1355999 },
        BRYAT: { name: 'Borusan Yatırım Pazarlama', sector: 'Holding ve Yatırım', basePrice: 1832.0, volatility: 0.015, drift: 0.0005, avgVolume: 269000 },
        ...
        CCOLA: { name: 'Coca-Cola İçecek', sector: 'Gıda, İçecek', basePrice: 84.45, volatility: 0.02, drift: 0.0003, avgVolume: 7464000 },
        CEMTS: { name: 'Çemtaş Çelik Makina', sector: 'Metal Ana Sanayii', basePrice: 9.38, volatility: 0.028, drift: 0.0005, avgVolume: 69300000 },
        CIMSA: { name: 'Çimsa Çimento', sector: 'Çimento', basePrice: 46.9, volatility: 0.025, drift: 0.0008, avgVolume: 12329999 },
        CWENE: { name: 'Cw Enerji Mühendislik', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 37.66, volatility: 0.02, drift: 0.0007, avgVolume: 20160000 },
        DOAS: { name: 'Doğuş Otomotiv Servis', sector: 'Otomotiv', basePrice: 186.0, volatility: 0.021, drift: 0.0004, avgVolume: 7230000 },
        DOHOL: { name: 'Doğan Şirketler Grubu', sector: 'Holding ve Yatırım', basePrice: 21.18, volatility: 0.024, drift: 0.0005, avgVolume: 55530000 },
        ECILC: { name: 'Eczacıbaşı İlaç', sector: 'İlaç ve Sağlık', basePrice: 75.9, volatility: 0.018, drift: 0.0007, avgVolume: 16595999 },
        ECZYT: { name: 'Eczacıbaşı Yatırım', sector: 'Holding ve Yatırım', basePrice: 349.75, volatility: 0.016, drift: 0.0006, avgVolume: 1318500 },
        EGEEN: { name: 'Ege Endüstri', sector: 'Otomotiv', basePrice: 5647.5, volatility: 0.015, drift: 0.0005, avgVolume: 209000 },
        EKGYO: { name: 'Emlak Konut GYO', sector: 'Gayrimenkul Yatırım Ortaklığı', basePrice: 20.48, volatility: 0.023, drift: 0.0008, avgVolume: 42435000 },
        ENJSA: { name: 'Enerjisa Enerji', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 104.0, volatility: 0.023, drift: 0.0006, avgVolume: 5994000 },
        ENKAI: { name: 'Enka İnşaat', sector: 'İnşaat', basePrice: 90.3, volatility: 0.018, drift: 0.0003, avgVolume: 3660000 },
        EREGL: { name: 'Ereğli Demir Çelik', sector: 'Metal Ana Sanayii', basePrice: 40.4, volatility: 0.027, drift: 0.0004, avgVolume: 25146000 },
        EUPWR: { name: 'Europower Enerji', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 91.45, volatility: 0.019, drift: 0.0004, avgVolume: 6258000 },
        FROTO: { name: 'Ford Otomotiv Sanayi', sector: 'Otomotiv', basePrice: 81.8, volatility: 0.022, drift: 0.0007, avgVolume: 8004000 },
        GARAN: { name: 'Garanti Bankası', sector: 'Bankacılık', basePrice: 129.0, volatility: 0.021, drift: 0.0004, avgVolume: 4206000 },
        GENIL: { name: 'Gen İlaç ve Sağlık', sector: 'İlaç ve Sağlık', basePrice: 8.81, volatility: 0.033, drift: 0.0004, avgVolume: 96030000 },
        GESAN: { name: 'Girişim Elektrik Sanayi', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 80.3, volatility: 0.018, drift: 0.0003, avgVolume: 4956000 },
        ...
        GUBRF: { name: 'Gübre Fabrikaları', sector: 'Kimya, Petrokimya', basePrice: 437.5, volatility: 0.015, drift: 0.0005, avgVolume: 1296000 },
        ...
        HALKB: { name: 'Halk Bankası', sector: 'Bankacılık', basePrice: 40.52, volatility: 0.024, drift: 0.0003, avgVolume: 20772000 },
        ...
        ISCTR: { name: 'İş Bankası (C)', sector: 'Bankacılık', basePrice: 13.78, volatility: 0.029, drift: 0.0008, avgVolume: 61155000 },
        ...
        ISMEN: { name: 'İş Yatırım Menkul Değerler', sector: 'Finansal Hizmetler', basePrice: 34.86, volatility: 0.02, drift: 0.0005, avgVolume: 16199999 },
        ...
        KCAER: { name: 'Kocaer Çelik', sector: 'Metal Ana Sanayii', basePrice: 13.39, volatility: 0.028, drift: 0.0007, avgVolume: 61110000 },
        KCHOL: { name: 'Koç Holding', sector: 'Holding ve Yatırım', basePrice: 192.8, volatility: 0.021, drift: 0.0006, avgVolume: 7134000 },
        KMPUR: { name: 'Kimteks Poliüretan', sector: 'Kimya, Petrokimya', basePrice: 21.2, volatility: 0.029, drift: 0.0006, avgVolume: 62055000 },
        KONTR: { name: 'Kontrolmatik Teknoloji', sector: 'Teknoloji', basePrice: 5.42, volatility: 0.034, drift: 0.0005, avgVolume: 54720000 },
        KONYA: { name: 'Konya Çimento', sector: 'Çimento', basePrice: 3875.0, volatility: 0.015, drift: 0.0005, avgVolume: 186500 },
        ...
        KRDMD: { name: 'Kardemir Karabük', sector: 'Metal Ana Sanayii', basePrice: 37.78, volatility: 0.02, drift: 0.0007, avgVolume: 16920000 },
        MAVI: { name: 'Mavi Giyim', sector: 'Tekstil', basePrice: 39.62, volatility: 0.021, drift: 0.0004, avgVolume: 23598000 },
        MGROS: { name: 'Migros Ticaret', sector: 'Perakende Ticaret', basePrice: 625.5, volatility: 0.015, drift: 0.0005, avgVolume: 253000 },
        MIATK: { name: 'Mia Teknoloji', sector: 'Teknoloji', basePrice: 31.3, volatility: 0.024, drift: 0.0005, avgVolume: 21672000 },
        ODAS: { name: 'Odaş Elektrik', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 8.29, volatility: 0.033, drift: 0.0004, avgVolume: 66150000 },
        OTKAR: { name: 'Otokar Otomotiv', sector: 'Otomotiv', basePrice: 338.0, volatility: 0.014, drift: 0.0004, avgVolume: 1462500 },
        OYAKC: { name: 'Oyak Çimento', sector: 'Çimento', basePrice: 20.2, volatility: 0.025, drift: 0.0006, avgVolume: 27675000 },
        PENTA: { name: 'Penta Teknoloji', sector: 'Teknoloji', basePrice: 13.47, volatility: 0.026, drift: 0.0007, avgVolume: 48869999 },
        PETKM: { name: 'Petkim Petrokimya', sector: 'Kimya, Petrokimya', basePrice: 19.34, volatility: 0.025, drift: 0.0004, avgVolume: 44325000 },
        PGSUS: { name: 'Pegasus Hava Taşımacılığı', sector: 'Ulaştırma', basePrice: 170.2, volatility: 0.018, drift: 0.0003, avgVolume: 4332000 },
        PSGYO: { name: 'Pasifik GYO', sector: 'Gayrimenkul Yatırım Ortaklığı', basePrice: 3.15, volatility: 0.032, drift: 0.0003, avgVolume: 108180000 },
        QUAGR: { name: 'Qua Granite Hayal Yapı', sector: 'İnşaat', basePrice: 3.53, volatility: 0.026, drift: 0.0003, avgVolume: 106560000 },
        SAHOL: { name: 'Sabancı Holding', sector: 'Holding ve Yatırım', basePrice: 90.5, volatility: 0.023, drift: 0.0006, avgVolume: 5850000 },
        SASA: { name: 'Sasa Polyester', sector: 'Kimya, Petrokimya', basePrice: 2.42, volatility: 0.034, drift: 0.0005, avgVolume: 68040000 },
        ...
        SISE: { name: 'Şişecam', sector: 'Cam', basePrice: 43.44, volatility: 0.028, drift: 0.0005, avgVolume: 22464000 },
        SKBNK: { name: 'Şekerbank', sector: 'Bankacılık', basePrice: 19.27, volatility: 0.027, drift: 0.0008, avgVolume: 48915000 },
        SMRTG: { name: 'Smart Güneş Enerjisi', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 11.11, volatility: 0.027, drift: 0.0004, avgVolume: 46214999 },
        SOKM: { name: 'Şok Marketler', sector: 'Perakende Ticaret', basePrice: 46.14, volatility: 0.024, drift: 0.0005, avgVolume: 21132000 },
        TABGD: { name: 'Tab Gıda Sanayi', sector: 'Gıda, İçecek', basePrice: 238.0, volatility: 0.013, drift: 0.0003, avgVolume: 1311000 },
        TAVHL: { name: 'TAV Havalimanları', sector: 'Ulaştırma', basePrice: 269.25, volatility: 0.018, drift: 0.0008, avgVolume: 1399500 },
        TCELL: { name: 'Turkcell', sector: 'Telekomünikasyon', basePrice: 107.0, volatility: 0.022, drift: 0.0003, avgVolume: 6611999 },
        TEZOL: { name: 'Europap Tezol Kağıt', sector: 'Kağıt', basePrice: 15.85, volatility: 0.028, drift: 0.0005, avgVolume: 43110000 },
        THYAO: { name: 'Türk Hava Yolları', sector: 'Ulaştırma', basePrice: 344.5, volatility: 0.018, drift: 0.0008, avgVolume: 1408500 },
        TKFEN: { name: 'Tekfen Holding', sector: 'Holding ve Yatırım', basePrice: 137.3, volatility: 0.016, drift: 0.0007, avgVolume: 5856000 },
        TOASO: { name: 'Tofaş Türk Otomobil Fabrikası', sector: 'Otomotiv', basePrice: 302.75, volatility: 0.013, drift: 0.0003, avgVolume: 2055000 },
        TSKB: { name: 'TSKB', sector: 'Bankacılık', basePrice: 11.53, volatility: 0.028, drift: 0.0005, avgVolume: 53910000 },
        TTKOM: { name: 'Türk Telekom', sector: 'Telekomünikasyon', basePrice: 58.0, volatility: 0.017, drift: 0.0006, avgVolume: 10962000 },
        TTRAK: { name: 'Türk Traktör', sector: 'Otomotiv', basePrice: 439.75, volatility: 0.013, drift: 0.0003, avgVolume: 1949999 },
        TUPRS: { name: 'Tüpraş', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 267.0, volatility: 0.013, drift: 0.0003, avgVolume: 1355999 },
        TURSG: { name: 'Türkiye Sigorta', sector: 'Sigorta', basePrice: 6.35, volatility: 0.035, drift: 0.0006, avgVolume: 112050000 },
        ULKER: { name: 'Ülker Bisküvi', sector: 'Gıda, İçecek', basePrice: 97.0, volatility: 0.017, drift: 0.0006, avgVolume: 4181999 },
        VAKBN: { name: 'Vakıflar Bankası', sector: 'Bankacılık', basePrice: 31.18, volatility: 0.02, drift: 0.0007, avgVolume: 21960000 },
        VESBE: { name: 'Vestel Beyaz Eşya', sector: 'Dayanıklı Tüketim', basePrice: 6.33, volatility: 0.033, drift: 0.0004, avgVolume: 77670000 },
        VESTL: { name: 'Vestel Elektronik', sector: 'Dayanıklı Tüketim', basePrice: 26.42, volatility: 0.028, drift: 0.0005, avgVolume: 28260000 },
        YEOTK: { name: 'Yeo Teknoloji', sector: 'Teknoloji', basePrice: 89.1, volatility: 0.018, drift: 0.0003, avgVolume: 5676000 },
        YKBNK: { name: 'Yapı ve Kredi Bankası', sector: 'Bankacılık', basePrice: 35.14, volatility: 0.023, drift: 0.0008, avgVolume: 11034000 },
        YYLGD: { name: 'Yayla Agro Gıda', sector: 'Gıda, İçecek', basePrice: 11.4, volatility: 0.023, drift: 0.0006, avgVolume: 30284999 },
        ZOREN: { name: 'Zorlu Enerji', sector: 'Enerji (Üretim/Dağıtım)', basePrice: 2.73, volatility: 0.028, drift: 0.0005, avgVolume: 71820000 }
    };
