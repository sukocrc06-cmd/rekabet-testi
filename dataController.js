...
const DataController = (() => {
    ...
    const STOCK_PROFILES = {
        AEFES: { name: 'Anadolu Efes', sector: 'BIST Hissesi', basePrice: 20.46, volatility: 0.026, drift: 0.0005, avgVolume: 42120000 },
        AGESA: { name: 'Agesa Hayat ve Emeklilik', sector: 'BIST Hissesi', basePrice: 240.2, volatility: 0.018, drift: 0.0008, avgVolume: 1159499 },
        AKBNK: { name: 'Akbank', sector: 'BIST Hissesi', basePrice: 68.75, volatility: 0.021, drift: 0.0008, avgVolume: 16362000 },
        AKCNS: { name: 'Akçansa Çimento', sector: 'BIST Hissesi', basePrice: 238.05, volatility: 0.015, drift: 0.0005, avgVolume: 1616999 },
        AKFGY: { name: 'Akfen GYO', sector: 'BIST Hissesi', basePrice: 2.78, volatility: 0.036, drift: 0.0007, avgVolume: 121500000 },
        AKSEN: { name: 'Aksa Enerji', sector: 'BIST Hissesi', basePrice: 92.1, volatility: 0.018, drift: 0.0007, avgVolume: 5820000 },
        ALARK: { name: 'Alarko Holding', sector: 'BIST Hissesi', basePrice: 100.3, volatility: 0.023, drift: 0.0006, avgVolume: 6378000 },
        ALBRK: { name: 'Albaraka Türk', sector: 'BIST Hissesi', basePrice: 8.13, volatility: 0.03, drift: 0.0007, avgVolume: 110160000 },
        ALFAS: { name: 'Alfa Solar Enerji', sector: 'BIST Hissesi', basePrice: 45.98, volatility: 0.029, drift: 0.0008, avgVolume: 24282000 },
        ARCLK: { name: 'Arçelik', sector: 'BIST Hissesi', basePrice: 98.9, volatility: 0.017, drift: 0.0008, avgVolume: 4470000 },
        ASELS: { name: 'Aselsan', sector: 'BIST Hissesi', basePrice: 370.0, volatility: 0.017, drift: 0.0007, avgVolume: 1899000 },
        ASTOR: { name: 'Astor Enerji', sector: 'BIST Hissesi', basePrice: 325.75, volatility: 0.016, drift: 0.0006, avgVolume: 2059500 },
        BERA: { name: 'Bera Holding', sector: 'BIST Hissesi', basePrice: 15.0, volatility: 0.022, drift: 0.0003, avgVolume: 59490000 },
        BIMAS: { name: 'BİM Mağazalar', sector: 'BIST Hissesi', basePrice: 372.5, volatility: 0.017, drift: 0.0007, avgVolume: 936000 },
        BRSAN: { name: 'Borusan Mannesmann', sector: 'BIST Hissesi', basePrice: 536.0, volatility: 0.015, drift: 0.0005, avgVolume: 1355999 },
        BRYAT: { name: 'Borusan Yatırım Pazarlama', sector: 'BIST Hissesi', basePrice: 1832.0, volatility: 0.015, drift: 0.0005, avgVolume: 269000 },
        BUCIM: { name: 'Bursa Çimento', sector: 'BIST Hissesi', basePrice: 5.87, volatility: 0.034, drift: 0.0005, avgVolume: 67320000 },
        CANTE: { name: 'Çan2 Termik', sector: 'BIST Hissesi', basePrice: 1.28, volatility: 0.035, drift: 0.0006, avgVolume: 85770000 },
        CCOLA: { name: 'Coca-Cola İçecek', sector: 'BIST Hissesi', basePrice: 84.45, volatility: 0.02, drift: 0.0003, avgVolume: 7464000 },
        CEMTS: { name: 'Çemtaş Çelik Makina', sector: 'BIST Hissesi', basePrice: 9.38, volatility: 0.028, drift: 0.0005, avgVolume: 69300000 },
        CIMSA: { name: 'Çimsa Çimento', sector: 'BIST Hissesi', basePrice: 46.9, volatility: 0.025, drift: 0.0008, avgVolume: 12329999 },
        CWENE: { name: 'Cw Enerji Mühendislik', sector: 'BIST Hissesi', basePrice: 37.66, volatility: 0.02, drift: 0.0007, avgVolume: 20160000 },
        DOAS: { name: 'Doğuş Otomotiv Servis', sector: 'BIST Hissesi', basePrice: 186.0, volatility: 0.021, drift: 0.0004, avgVolume: 7230000 },
        DOHOL: { name: 'Doğan Şirketler Grubu', sector: 'BIST Hissesi', basePrice: 21.18, volatility: 0.024, drift: 0.0005, avgVolume: 55530000 },
        ECILC: { name: 'Eczacıbaşı İlaç', sector: 'BIST Hissesi', basePrice: 75.9, volatility: 0.018, drift: 0.0007, avgVolume: 16595999 },
        ECZYT: { name: 'Eczacıbaşı Yatırım', sector: 'BIST Hissesi', basePrice: 349.75, volatility: 0.016, drift: 0.0006, avgVolume: 1318500 },
        EGEEN: { name: 'Ege Endüstri', sector: 'BIST Hissesi', basePrice: 5647.5, volatility: 0.015, drift: 0.0005, avgVolume: 209000 },
        EKGYO: { name: 'Emlak Konut GYO', sector: 'BIST Hissesi', basePrice: 20.48, volatility: 0.023, drift: 0.0008, avgVolume: 42435000 },
        ENJSA: { name: 'Enerjisa Enerji', sector: 'BIST Hissesi', basePrice: 104.0, volatility: 0.023, drift: 0.0006, avgVolume: 5994000 },
        ENKAI: { name: 'Enka İnşaat', sector: 'BIST Hissesi', basePrice: 90.3, volatility: 0.018, drift: 0.0003, avgVolume: 3660000 },
        EREGL: { name: 'Ereğli Demir Çelik', sector: 'BIST Hissesi', basePrice: 40.4, volatility: 0.027, drift: 0.0004, avgVolume: 25146000 },
        EUPWR: { name: 'Europower Enerji', sector: 'BIST Hissesi', basePrice: 91.45, volatility: 0.019, drift: 0.0004, avgVolume: 6258000 },
        FROTO: { name: 'Ford Otomotiv Sanayi', sector: 'BIST Hissesi', basePrice: 81.8, volatility: 0.022, drift: 0.0007, avgVolume: 8004000 },
        GARAN: { name: 'Garanti Bankası', sector: 'BIST Hissesi', basePrice: 129.0, volatility: 0.021, drift: 0.0004, avgVolume: 4206000 },
        GENIL: { name: 'Gen İlaç ve Sağlık', sector: 'BIST Hissesi', basePrice: 8.81, volatility: 0.033, drift: 0.0004, avgVolume: 96030000 },
        GESAN: { name: 'Girişim Elektrik Sanayi', sector: 'BIST Hissesi', basePrice: 80.3, volatility: 0.018, drift: 0.0003, avgVolume: 4956000 },
        GLYHO: { name: 'Global Yatırım Holding', sector: 'BIST Hissesi', basePrice: 18.73, volatility: 0.027, drift: 0.0006, avgVolume: 42615000 },
        GSDHO: { name: 'GSD Holding', sector: 'BIST Hissesi', basePrice: 6.04, volatility: 0.033, drift: 0.0004, avgVolume: 117270000 },
        GUBRF: { name: 'Gübre Fabrikaları', sector: 'BIST Hissesi', basePrice: 437.5, volatility: 0.015, drift: 0.0005, avgVolume: 1296000 },
        GWIND: { name: 'Galata Wind Enerji', sector: 'BIST Hissesi', basePrice: 26.1, volatility: 0.027, drift: 0.0008, avgVolume: 29115000 },
        HALKB: { name: 'Halk Bankası', sector: 'BIST Hissesi', basePrice: 40.52, volatility: 0.024, drift: 0.0003, avgVolume: 20772000 },
        HEKTS: { name: 'Hektaş', sector: 'BIST Hissesi', basePrice: 3.03, volatility: 0.031, drift: 0.0008, avgVolume: 112770000 },
        IPEKE: { name: 'İpek Doğal Enerji', sector: 'BIST Hissesi', basePrice: 91.9, volatility: 0.016, drift: 0.0003, avgVolume: 4896000 },
        ISCTR: { name: 'İş Bankası (C)', sector: 'BIST Hissesi', basePrice: 13.78, volatility: 0.029, drift: 0.0008, avgVolume: 61155000 },
        ISDMR: { name: 'İskenderun Demir Çelik', sector: 'BIST Hissesi', basePrice: 56.7, volatility: 0.023, drift: 0.0008, avgVolume: 23454000 },
        ISGYO: { name: 'İş GYO', sector: 'BIST Hissesi', basePrice: 20.26, volatility: 0.025, drift: 0.0008, avgVolume: 60975000 },
        ISMEN: { name: 'İş Yatırım Menkul Değerler', sector: 'BIST Hissesi', basePrice: 34.86, volatility: 0.02, drift: 0.0005, avgVolume: 16199999 },
        IZMDC: { name: 'İzmir Demir Çelik', sector: 'BIST Hissesi', basePrice: 11.13, volatility: 0.025, drift: 0.0006, avgVolume: 62775000 },
        KARDMD: { name: 'Kardemir (D)', sector: 'BIST Hissesi', basePrice: 40.86, volatility: 0.025, drift: 0.0006, avgVolume: 15390000 },
        KCAER: { name: 'Kocaer Çelik', sector: 'BIST Hissesi', basePrice: 13.39, volatility: 0.028, drift: 0.0007, avgVolume: 61110000 },
        KCHOL: { name: 'Koç Holding', sector: 'BIST Hissesi', basePrice: 192.8, volatility: 0.021, drift: 0.0006, avgVolume: 7134000 },
        KMPUR: { name: 'Kimteks Poliüretan', sector: 'BIST Hissesi', basePrice: 21.2, volatility: 0.029, drift: 0.0006, avgVolume: 62055000 },
        KONTR: { name: 'Kontrolmatik Teknoloji', sector: 'BIST Hissesi', basePrice: 5.42, volatility: 0.034, drift: 0.0005, avgVolume: 54720000 },
        KONYA: { name: 'Konya Çimento', sector: 'BIST Hissesi', basePrice: 3875.0, volatility: 0.015, drift: 0.0005, avgVolume: 186500 },
        KORDS: { name: 'Kordsa Teknik Tekstil', sector: 'BIST Hissesi', basePrice: 79.9, volatility: 0.021, drift: 0.0006, avgVolume: 13626000 },
        KOZAA: { name: 'Koza Anadolu Metal', sector: 'BIST Hissesi', basePrice: 119.7, volatility: 0.022, drift: 0.0005, avgVolume: 6803999 },
        KOZAL: { name: 'Koza Altın İşletmeleri', sector: 'BIST Hissesi', basePrice: 50.25, volatility: 0.017, drift: 0.0004, avgVolume: 20610000 },
        KRDMD: { name: 'Kardemir Karabük', sector: 'BIST Hissesi', basePrice: 37.78, volatility: 0.02, drift: 0.0007, avgVolume: 16920000 },
        MAVI: { name: 'Mavi Giyim', sector: 'BIST Hissesi', basePrice: 39.62, volatility: 0.021, drift: 0.0004, avgVolume: 23598000 },
        MGROS: { name: 'Migros Ticaret', sector: 'BIST Hissesi', basePrice: 625.5, volatility: 0.015, drift: 0.0005, avgVolume: 253000 },
        MIATK: { name: 'Mia Teknoloji', sector: 'BIST Hissesi', basePrice: 31.3, volatility: 0.024, drift: 0.0005, avgVolume: 21672000 },
        ODAS: { name: 'Odaş Elektrik', sector: 'BIST Hissesi', basePrice: 8.29, volatility: 0.033, drift: 0.0004, avgVolume: 66150000 },
        OTKAR: { name: 'Otokar Otomotiv', sector: 'BIST Hissesi', basePrice: 338.0, volatility: 0.014, drift: 0.0004, avgVolume: 1462500 },
        OYAKC: { name: 'Oyak Çimento', sector: 'BIST Hissesi', basePrice: 20.2, volatility: 0.025, drift: 0.0006, avgVolume: 27675000 },
        PENTA: { name: 'Penta Teknoloji', sector: 'BIST Hissesi', basePrice: 13.47, volatility: 0.026, drift: 0.0007, avgVolume: 48869999 },
        PETKM: { name: 'Petkim Petrokimya', sector: 'BIST Hissesi', basePrice: 19.34, volatility: 0.025, drift: 0.0004, avgVolume: 44325000 },
        PGSUS: { name: 'Pegasus Hava Taşımacılığı', sector: 'BIST Hissesi', basePrice: 170.2, volatility: 0.018, drift: 0.0003, avgVolume: 4332000 },
        PSGYO: { name: 'Pasifik GYO', sector: 'BIST Hissesi', basePrice: 3.15, volatility: 0.032, drift: 0.0003, avgVolume: 108180000 },
        QUAGR: { name: 'Qua Granite Hayal Yapı', sector: 'BIST Hissesi', basePrice: 3.53, volatility: 0.026, drift: 0.0003, avgVolume: 106560000 },
        SAHOL: { name: 'Sabancı Holding', sector: 'BIST Hissesi', basePrice: 90.5, volatility: 0.023, drift: 0.0006, avgVolume: 5850000 },
        SASA: { name: 'Sasa Polyester', sector: 'BIST Hissesi', basePrice: 2.42, volatility: 0.034, drift: 0.0005, avgVolume: 68040000 },
        SAYAS: { name: 'Say Yenilenebilir Enerji', sector: 'BIST Hissesi', basePrice: 45.32, volatility: 0.025, drift: 0.0004, avgVolume: 15930000 },
        SDTTR: { name: 'SDT Uzay ve Savunma', sector: 'BIST Hissesi', basePrice: 264.5, volatility: 0.018, drift: 0.0008, avgVolume: 1861500 },
        SISE: { name: 'Şişecam', sector: 'BIST Hissesi', basePrice: 43.44, volatility: 0.028, drift: 0.0005, avgVolume: 22464000 },
        SKBNK: { name: 'Şekerbank', sector: 'BIST Hissesi', basePrice: 19.27, volatility: 0.027, drift: 0.0008, avgVolume: 48915000 },
        SMRTG: { name: 'Smart Güneş Enerjisi', sector: 'BIST Hissesi', basePrice: 11.11, volatility: 0.027, drift: 0.0004, avgVolume: 46214999 },
        SOKM: { name: 'Şok Marketler', sector: 'BIST Hissesi', basePrice: 46.14, volatility: 0.024, drift: 0.0005, avgVolume: 21132000 },
        TABGD: { name: 'Tab Gıda Sanayi', sector: 'BIST Hissesi', basePrice: 238.0, volatility: 0.013, drift: 0.0003, avgVolume: 1311000 },
        TAVHL: { name: 'TAV Havalimanları', sector: 'BIST Hissesi', basePrice: 269.25, volatility: 0.018, drift: 0.0008, avgVolume: 1399500 },
        TCELL: { name: 'Turkcell', sector: 'BIST Hissesi', basePrice: 107.0, volatility: 0.022, drift: 0.0003, avgVolume: 6611999 },
        TEZOL: { name: 'Europap Tezol Kağıt', sector: 'BIST Hissesi', basePrice: 15.85, volatility: 0.028, drift: 0.0005, avgVolume: 43110000 },
        THYAO: { name: 'Türk Hava Yolları', sector: 'BIST Hissesi', basePrice: 344.5, volatility: 0.018, drift: 0.0008, avgVolume: 1408500 },
        TKFEN: { name: 'Tekfen Holding', sector: 'BIST Hissesi', basePrice: 137.3, volatility: 0.016, drift: 0.0007, avgVolume: 5856000 },
        TOASO: { name: 'Tofaş Türk Otomobil Fabrikası', sector: 'BIST Hissesi', basePrice: 302.75, volatility: 0.013, drift: 0.0003, avgVolume: 2055000 },
        TSKB: { name: 'TSKB', sector: 'BIST Hissesi', basePrice: 11.53, volatility: 0.028, drift: 0.0005, avgVolume: 53910000 },
        TTKOM: { name: 'Türk Telekom', sector: 'BIST Hissesi', basePrice: 58.0, volatility: 0.017, drift: 0.0006, avgVolume: 10962000 },
        TTRAK: { name: 'Türk Traktör', sector: 'BIST Hissesi', basePrice: 439.75, volatility: 0.013, drift: 0.0003, avgVolume: 1949999 },
        TUPRS: { name: 'Tüpraş', sector: 'BIST Hissesi', basePrice: 267.0, volatility: 0.013, drift: 0.0003, avgVolume: 1355999 },
        TURSG: { name: 'Türkiye Sigorta', sector: 'BIST Hissesi', basePrice: 6.35, volatility: 0.035, drift: 0.0006, avgVolume: 112050000 },
        ULKER: { name: 'Ülker Bisküvi', sector: 'BIST Hissesi', basePrice: 97.0, volatility: 0.017, drift: 0.0006, avgVolume: 4181999 },
        VAKBN: { name: 'Vakıflar Bankası', sector: 'BIST Hissesi', basePrice: 31.18, volatility: 0.02, drift: 0.0007, avgVolume: 21960000 },
        VESBE: { name: 'Vestel Beyaz Eşya', sector: 'BIST Hissesi', basePrice: 6.33, volatility: 0.033, drift: 0.0004, avgVolume: 77670000 },
        VESTL: { name: 'Vestel Elektronik', sector: 'BIST Hissesi', basePrice: 26.42, volatility: 0.028, drift: 0.0005, avgVolume: 28260000 },
        YEOTK: { name: 'Yeo Teknoloji', sector: 'BIST Hissesi', basePrice: 89.1, volatility: 0.018, drift: 0.0003, avgVolume: 5676000 },
        YKBNK: { name: 'Yapı ve Kredi Bankası', sector: 'BIST Hissesi', basePrice: 35.14, volatility: 0.023, drift: 0.0008, avgVolume: 11034000 },
        YYLGD: { name: 'Yayla Agro Gıda', sector: 'BIST Hissesi', basePrice: 11.4, volatility: 0.023, drift: 0.0006, avgVolume: 30284999 },
        ZOREN: { name: 'Zorlu Enerji', sector: 'BIST Hissesi', basePrice: 2.73, volatility: 0.028, drift: 0.0005, avgVolume: 71820000 }
    };
