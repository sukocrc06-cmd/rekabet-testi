...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function exportToPDF() {
        ...
        fetch('https://optipulse-backend-production.up.railway.app/api/v1/backtest/export', {
            method: 'POST',
    ...
    function executePipeline() {
        ...
        fetch('https://optipulse-backend-production.up.railway.app/api/v1/backtest/run', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                ticker: state.selectedAsset,
        ...
        .catch(err => {
            const targetUrl = 'https://optipulse-backend-production.up.railway.app/api/v1/backtest/run';
    ...
    function updateClockAndHeartbeat() {
        ...
        fetch('https://optipulse-backend-production.up.railway.app/api/v1/health')
            .then(res => {
